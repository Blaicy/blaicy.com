...
const MainPage = () => {
  return (
    <div className="p-2 sm:p-1 lg:p-2">
      <motion.div className="flex flex-col sm:flex-row items-center sm:space-x-2 space-y-1 sm:space-y-0">
        <motion.img 
          src="./1.png"
        ...
        <motion.h1 
          ...
          Blaicy Mokaya</motion.h1>
      </motion.div>

      <motion.div 
        className="min-h-screen flex flex-col items-center space-y-3 sm:space-y-4"
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-3">
          <a href="https://www.X.com/98_Howie" target="_blank" rel="noopener noreferrer" className="w-6 sm:w-8 lg:w-10 h-6 sm:h-8 lg:h-10 hover:opacity-50">
            <img src="./social-media.png" />
          </a>
          <a href="https://www.instagram.com/_blaicy" target="_blank" rel="noopener noreferrer" className="w-6 sm:w-8 lg:w-10 h-6 sm:h-8 lg:h-10 hover:opacity-50">
            <img src="./instagram.png" />
          </a>
          <a href="https://www.linkedin.com/in/blaicymokaya" target="_blank" rel="noopener noreferrer" className="w-6 sm:w-8 lg:w-10 h-6 sm:h-8 lg:h-10 hover:opacity-50">
            <img src="./linkedin.png" />
          </a>
          <a href="https://github.com/Blaicy" target="_blank" rel="noopener noreferrer" className="w-6 sm:w-8 lg:w-10 h-6 sm:h-8 lg:h-10 hover:opacity-50">
            <img src="./github.png" />
          </a>
        </div>
      </motion.div>
